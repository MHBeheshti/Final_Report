...
\begin{figure}
	\centering
	\includegraphics[scale=0.4]{Images/fig45.png}
	\caption{نمودار پترن تشعشعی}
	\label{fig45}
\end{figure}
...
\begin{figure}
	...
	\begin{subfigure}{0.5\textwidth} % width of left subfigure
		\includegraphics[scale=0.30]{Images/fig46.jpg}
		\caption{نمای آنتن} % subcaption
	\end{subfigure}
	\vspace{1em} % here you can insert horizontal or vertical space
	\begin{subfigure}{0.5\textwidth} % width of right subfigure
		\includegraphics[scale=0.30]{Images/fig47.jpg}
		\caption{نمودار تزویج متقابل آنتن با فراماده بین دو پچ} % subcaption
	\end{subfigure}
    \caption{
        شبیه سازی در محیط \lr{CST}
    }
\end{figure}